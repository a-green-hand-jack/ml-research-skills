...
- Next phase trigger: a tagged skill-system release or a successful full audit showing memory, sidecar routing, personalization writeback, source-card routing, token telemetry, and code review protocols are consistently wired across high-value skills.
...
| maintenance | partial | docs, memory, sidecars, tags, telemetry, personalization writeback, source-card routing, paper-layout protocols, visual-style memory, layered writing contracts, and commit closeout paths remain current | CLM-001, CLM-003, CLM-004, CLM-006, CLM-008, CLM-009, CLM-010, CLM-011, CLM-012, CLM-013 | EVD-004, EVD-006, EVD-007, EVD-010, EVD-011, EVD-012, EVD-013, EVD-014, EVD-015 | RSK-003, RSK-004, RSK-002, RSK-006, RSK-007 | ACT-001, ACT-004, ACT-006, ACT-011, ACT-012, ACT-013, ACT-014, ACT-015, ACT-016 |
