...
| PC-003 | Use `python3 scripts/validate_skills.py` and `uv run scripts/validate_skill_taxonomy.py` before committing skill, template, helper, inventory, or memory protocol changes. | validation | 2026-05-05 | First validator covers 73 skills and routing/template sanity. Second covers router-child consistency, expected_path chains, memory contracts, and skill-index.yaml. |
