...
| `submit-paper` | Run a pre-submission readiness check for a LaTeX paper project, using local static checks plus the configured compile backend without recording one user's local TeX availability |
