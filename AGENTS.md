...
| `submit-paper` | Run a pre-submission readiness check for a LaTeX paper project, using local static checks plus Overleaf/GitHub compilation by default and local compile only when explicitly requested and available |
