...
%%% Section Notation %%%
\makeatletter
\@ifpackageloaded{cleveref}{}{\usepackage[capitalize,noabbrev]{cleveref}}
\makeatother
...
%%%Claim%%%
\newenvironment{claim}{
  \begin{mdframed}[linecolor=black!0,backgroundcolor=black!10]\noindent%\itshape
  \ignorespaces}{
\end{mdframed}}
...
\@ifclassloaded{acmart}{}{%
  \@ifpackageloaded{natbib}{\let\cite\citep}{}%
}
\makeatother
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\makeatletter
\newcommand{\prismmaybeboxenvironment}[1]{%
  \@ifundefined{#1}{}{%
...
\newcommand{\prismmaybecrefname}[3]{%
  \@ifpackageloaded{cleveref}{\crefname{#1}{#2}{#3}}{}%
}
\makeatother
...
\makeatother
\prismmaybeboxenvironment{theorem}
\prismmaybeboxenvironment{lemma}
\prismmaybeboxenvironment{corollary}
\theoremstyle{definition}
\makeatletter
\@ifundefined{definition}{\newtheorem{definition}{Definition}[section]}{}
\makeatother
\prismmaybeboxenvironment{definition}
% \theoremstyle{definition}
\theoremstyle{remark}
\makeatletter
...
\makeatother
\prismmaybeboxenvironment{assumption}
\prismmaybeboxenvironment{problem}

\prismmaybecrefname{theorem}{Theorem}{Theorems}
\prismmaybecrefname{proposition}{Proposition}{Propositions}
\prismmaybecrefname{lemma}{Lemma}{Lemmas}
\prismmaybecrefname{corollary}{Corollary}{Corollaries}
\prismmaybecrefname{definition}{Definition}{Definitions}
\prismmaybecrefname{assumption}{Assumption}{Assumptions}
\prismmaybecrefname{remark}{Remark}{Remarks}
\prismmaybecrefname{problem}{Problem}{Problems}
\prismmaybecrefname{property}{Property}{Properties}
...
% Automatic \sin/\cos rewriting is disabled by default. It changes LaTeX's
% standard operator behavior and is hard to reason about across venues.
