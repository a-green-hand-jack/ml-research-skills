# {{PROJECT_NAME}} Phase Dashboard

> Global project-cycle view. Re-verify volatile facts before acting.
...
| maintenance | partial | docs, memory, tags, and timeline current |  |  |  |  |

## Stale Or Regressed Objects

| Object | Why stale/regressed | Required check | Owner | Updated |
|---|---|---|---|---|
| CLM-000 | Fill in if a claim, result, section, or asset may be stale. | Verify source. | agent | {{DATE}} |
